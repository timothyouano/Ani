...
## Use the sources
Follow this steps to use the sources of "RT-Voice PRO":

1. Inside your project in Unity, go to menu "File" => "New Scene"
2. Delete the "RTVoice.dll" under "Assets/crosstales/RTVoice/Plugins"
